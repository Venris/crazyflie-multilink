...
class Ui_Dron(object):
    ...
    def retranslateUi(self, Dron):
        ...
        self.l_theta_2.setText(_translate("Dron", "Yaw: ", None))
        self.groupBox_3.setTitle(_translate("Dron", "CF data", None))
        self.l_vz_2.setText(_translate("Dron", "Thrust:", None))
        self.l_vx_2.setText(_translate("Dron", "Roll:", None))
        self.l_vy_2.setText(_translate("Dron", "Pitch:", None))
        self.l_vtheta_2.setText(_translate("Dron", "Yaw:", None))
        ...
        self.groupBox_4.setTitle(_translate("Dron", "Errors", None))
        self.l_thrust_a_2.setText(_translate("Dron", "Ez:", None))
        self.l_roll_a_2.setText(_translate("Dron", "Ex:", None))
        self.l_pitch_a_2.setText(_translate("Dron", "Ey:", None))
        self.l_yaw_a_2.setText(_translate("Dron", "Eyaw:", None))
        ...
        self.cb_sendCtrl.setText(_translate("Dron", "send control", None))
